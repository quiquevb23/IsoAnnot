...
"x86_64-linux-thread-multi-5.15.0-1041-azure" or
	die "Errno architecture (x86_64-linux-thread-multi-5.15.0-1041-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
